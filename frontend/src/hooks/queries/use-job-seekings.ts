...
import type { CreateJobSeekingRequest, UpdateJobSeekingRequest } from '@/types/job-posting';
...
export function useUpdateJobSeeking() {
  ...
  return useMutation({
    mutationFn: ({ seekingId, data }: { seekingId: number; data: Partial<UpdateJobSeekingRequest> }) =>
...
// Get job seeking memos (currently not implemented in API)
...
// Create job seeking memo (currently not implemented in API)
