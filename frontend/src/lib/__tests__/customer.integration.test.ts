  ...
  describe('create', () => {
    it('should create a new customer successfully', async () => {
      ...
      const createdCustomer: Customer = {
        ...
        birth_date: newCustomerData.birth_date ?? null,
  ...
  describe('update', () => {
    it('should update an existing customer', async () => {
      ...
      const updatedCustomer: Customer = {
        id: 1,
        user_id: 1,
        customer_type: updateData.customer_type ?? 'Employer',
        name: updateData.name ?? '기존 이름',
        phone: updateData.phone ?? '010-1234-5678',
        birth_date: updateData.birth_date ?? '1990-01-01',
        address: updateData.address ?? '대전시 유성구',
        profile_photo_id: null,
        created_at: '2024-01-01T00:00:00Z',
