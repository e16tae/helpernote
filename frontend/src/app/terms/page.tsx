      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-slate dark:prose-invert prose-headings:font-bold prose-h2:text-2xl prose-h3:text-xl prose-p:text-muted-foreground">
            ...
            <h2>제1조 (목적)</h2>
            <p>
              본 약관은 Helpernote(이하 "서비스 제공자")가 제공하는 소개소 관리 시스템 서비스(이하 "서비스")의
            ...
            <ol>
              <li>
                "서비스"라 함은 서비스 제공자가 제공하는 소개소를 위한 통합 관리 플랫폼으로,
                고객 관리, 매칭 관리, 수수료 정산 등의 기능을 포함합니다.
              </li>
              <li>
                "이용자"라 함은 본 약관에 따라 서비스 제공자가 제공하는 서비스를 이용하는 회원을 말합니다.
              </li>
              <li>
                "회원"이라 함은 서비스 제공자와 서비스 이용계약을 체결하고 회원 아이디(ID)를 부여받은 자를 말합니다.
              </li>
              <li>
                "고객"이라 함은 회원이 관리하는 고용주 및 근로자를 말합니다.
              </li>
              <li>
                "콘텐츠"라 함은 정보통신망법의 규정에 따라 정보통신망에서 사용되는
