...
-- ================================================
-- 18. 샘플 데이터 삽입 (Optional - For Development/Testing Only)
-- ================================================
-- ⚠️  WARNING: This section contains sample data for development/testing purposes.
-- DO NOT use these values in production! They include hardcoded passwords and test data.
-- Uncomment only in secure, non-production environments.
...
-- ⚠️  COMMENTED OUT: Sample users with hardcoded passwords
-- These are for development ONLY. Create your own users in production!
